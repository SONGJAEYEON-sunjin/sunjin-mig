...
```sql
    ...
    select max(opnid) from ap_item_opn; -- 클렌징쿼리를 위한  예시 - 370154
    delete from AP_ITEM_OPN where opnid > ${max_opnid}; --  370154
    ALTER TABLE AP_ITEM_OPN AUTO_INCREMENT = ${max_opnid}+1 ; -- 370155
