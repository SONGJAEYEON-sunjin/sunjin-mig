...
```sql
    ...
    delete from DOC_ITEM_SCRT where itemid > ${minId}; # application-prod.yml 에서 tobe-min-itemid - 1 
    delete from AP_ITEM_SCRT where itemid > ${minId};
    delete from DOC_ITEM_SRCH where itemid > ${minId};
    delete from AP_ITEM_SRCH where itemid > ${minId};
    delete from DOC_ITEM_LINE where itemid > ${minId};
    delete from AP_ITEM_LINE where itemid > ${minId};
    delete from DOC_ITEM_OPN where itemid > ${minId};
    delete from AP_ITEM_OPN where itemid > ${minId};
    delete from DOC_ITEM_SHARE where itemid > ${minId};
    delete from AP_ITEM_SHARE where itemid > ${minId};
    delete from DOC_ITEM_FILE where itemid > ${minId};
    delete from AP_ITEM_FILE where itemid > ${minId};
    delete from DOC_ITEM_RFRN where itemid > ${minId};
    delete from AP_ITEM_RFRN where itemid > ${minId};
    delete from DOC_ITEM_RCVR where itemid > ${minId};
    delete from AP_ITEM_RFRN where itemid > ${minId};
    delete from DOC_ITEM_RCVR where itemid > ${minId};
    delete from AP_ITEM_RCVR where itemid > ${minId};
    delete from DOC_ITEM where itemid > ${minId};
    delete from AP_ITEM where itemid > ${minId};
